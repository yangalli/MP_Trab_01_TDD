...
TEST(TesteDaSomaAlgarismos, TesteSomaTresAlgarismos){ 
...
TEST(TesteDaSomaAlgarismos, TesteGeralSomaDoisAlgarismos){ 
...
TEST(TesteDaSomaAlgarismos, TesteGeralSomaTresAlgarismos){ 
...
TEST(TesteDaSomaDelimitador, TesteDelimitadoresGeral){ 
...
TEST(TesteDaSomaDelimitador, TesteGeralDelVariavel){ 
